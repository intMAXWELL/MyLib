...
import bingyan.net.myutil.BitmapUtil;
...
public class RotateImageAware implements ImageAware {
    ...
    /**
     * Constructor. <br />
     * References {@link #RotateImageAware(android.widget.ImageView, boolean) ImageViewAware(imageView, true)}.
     *
     * @param imageView {@link android.widget.ImageView ImageView} to work with
     */
    public RotateImageAware(ImageView imageView,String path) {
        this(imageView, true);
        this.path = path;
    }
     ...
     *                            <p/>
     */
    public RotateImageAware(ImageView imageView, boolean checkActualViewSize) {
